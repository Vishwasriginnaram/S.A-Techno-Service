...
import ac_service1 from "../../assests/ac_service1.jpeg";
import ac_service2 from "../../assests/ac_service2.jpeg";

const faqs = [
  {
    question: "Do you repair all types of ACs?",
    answer: "Yes, we repair all types of air conditioners including split, window, and inverter ACs.",
  },
  {
    question: "Do you provide gas filling?",
    answer: "Yes, we provide AC gas filling and top-up services with warranty.",
  },
  {
    question: "Do you install and uninstall ACs?",
    answer: "Yes, we offer AC installation and uninstallation services.",
  },
  {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-50 min-h-screen pt-24 pb-8 md:py-24 md:px-2">
      <div className="max-w-7xl mx-auto md:bg-white md:rounded-2xl md:shadow-2xl p-3 md:p-8">
        <h1 className="text-2xl md:text-4xl font-extrabold text-blue-700 text-center mb-3 md:mb-6">AC Repair Experts</h1>
        <p className="text-base text-center text-gray-600 mb-4 md:mb-8">Professional repair for split, window, and inverter air conditioners</p>
        ...
        <h2 className="text-center text-xl font-bold text-blue-700 mb-4">We Repair All Types of Air Conditioners</h2>
        ...
        <div className="bg-blue-50 rounded-xl p-3 md:p-6 text-center mt-4 md:mt-8">
          <h3 className="text-base md:text-lg font-bold text-blue-700 mb-2">Book Your AC Repair Today</h3>
