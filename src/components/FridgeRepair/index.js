...
import fridge_service1 from "../../assests/fridge_service1.jpeg"
import fridge_service2 from "../../assests/fridge_service2.jpeg";

const faqs = [
  {
    question: "Do you repair all fridge brands?",
    answer: "Yes, we repair all major fridge brands including Samsung, LG, Whirlpool, Godrej, and more.",
  },
  {
    question: "Is gas filling available?",
    answer: "Yes, we provide fridge gas filling and top-up services with warranty.",
  },
  {
    question: "Do you replace compressors?",
    answer: "We replace compressors with genuine parts and provide warranty on all replacements.",
  },
  {
    question: "Do you offer same-day service?",
    answer: "Yes, we offer same-day fridge repair service in most cases.",
  },
  {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-50 min-h-screen pt-24 pb-8 md:py-24 md:px-2">
      <div className="max-w-7xl mx-auto md:bg-white md:rounded-2xl md:shadow-2xl p-3 md:p-8">
        <h1 className="text-2xl md:text-4xl font-extrabold text-blue-700 text-center mb-3 md:mb-6">Fridge Repair Experts</h1>
        <p className="text-base text-center text-gray-600 mb-4 md:mb-8">Professional repair for single door, double door, and side-by-side refrigerators</p>
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-6 mb-8">
          ...
          <img
            src={fridge_service2}
            alt="Technician Repairing Fridge"
            className="rounded-xl w-full md:w-1/2 object-cover object-top h-64 border-4 border-blue-100 shadow"
            loading="lazy"
          />
        </div>

        <h2 className="text-center text-xl font-bold text-blue-700 mb-4">We Repair All Types of Refrigerators</h2>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-6">
          <li>Not cooling or overcooling</li>
          <li>Compressor issues</li>
          <li>Gas leakage or low gas</li>
          <li>Water leakage</li>
          <li>Door not closing</li>
        ...
        <div className="bg-blue-50 rounded-xl p-3 md:p-6 text-center mt-4 md:mt-8">
          <h3 className="text-base md:text-lg font-bold text-blue-700 mb-2">Book Your Fridge Repair Today</h3>
